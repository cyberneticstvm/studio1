...
<html>
	<head>
		...
		<title>Studio1Creators</title>	

		<meta name="keywords" content="WebSite Template" />
		<meta name="description" content="Studio1Creators - The Designing Studio">
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="{{ public_path().'/css/demos/demo-architecture-2.css' }}">

		<!-- Skin CSS -->
		<link id="skinCSS" rel="stylesheet" href="{{ public_path().'/css/skins/skin-architecture-2.css' }}">
	...
	<body class="loading-overlay-showing" data-loading-overlay data-plugin-page-transition>
											...
											<ul class="nav nav-pills" id="mainNav">
												...
												<li class="dropdown">
													...
													<ul class="dropdown-menu">
														...
														<li><a href="/" class="dropdown-item">Design & Planning</a></li>
														<li><a href="/" class="dropdown-item">Interior Design</a></li>
														<li><a href="/" class="dropdown-item">Exterior Design</a></li>
														<li><a href="/" class="dropdown-item">Construction Drawings</a></li>
													</ul>
												</li>
                    ...
                    <div class="container container-xl-custom pb-4">
                        ...
                        <div class="row py-5 my-3">
                            <div class="col text-center">
                                ...
                                <p class="text-3 mb-0">Studio1Creators © {{ date('Y') }}. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="{{ public_path().'/vendor/jquery.appear/jquery.appear.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/jquery.easing/jquery.easing.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/jquery.cookie/jquery.cookie.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/bootstrap/js/bootstrap.bundle.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/jquery.validation/jquery.validate.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/jquery.gmap/jquery.gmap.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/lazysizes/lazysizes.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/isotope/jquery.isotope.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/owl.carousel/owl.carousel.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/magnific-popup/jquery.magnific-popup.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/vide/jquery.vide.min.js' }}"></script>
        <script src="{{ public_path().'/vendor/vivus/vivus.min.js' }}"></script>

        <!-- Theme Base, Components and Settings -->
        <script src="{{ public_path().'/js/theme.js' }}"></script>

        <!-- Demo -->
        <script src="{{ public_path().'/js/demos/demo-architecture-2.js' }}"></script>
